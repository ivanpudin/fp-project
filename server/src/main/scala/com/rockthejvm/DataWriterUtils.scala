...
object DataWriterUtils {
  ...
  def main(args: Array[String]): Unit = {
    val sampleData = List(
      DataRow("Wind", "2024-01-01T00:00Z", "2024-01-01T01:00Z", 150.5),
      DataRow("Solar", "2024-01-01T00:00Z", "2024-01-01T01:00Z", 89.2),
      DataRow("Hydro", "2024-01-01T00:00Z", "2024-01-01T01:00Z", 300.0)
    )
